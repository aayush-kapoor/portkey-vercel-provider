...
import { convertUint8ArrayToBase64, generateId, isParsableJson } from '@ai-sdk/provider-utils';
...
export function getChatCompletionArgs({
    ...
    responseFormat,
    seed,
  }: Parameters<LanguageModelV1['doGenerate']>[0], settings: PortkeyChatCompletionSettings): {
...
export async function transformStream(inputStream: APIPromise<Stream<ChatCompletion>>) : Promise<ReadableStream<LanguageModelV1StreamPart>> {
