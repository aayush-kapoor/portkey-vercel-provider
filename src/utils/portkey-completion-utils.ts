import {
  ...
  export function getArgs({
    ...
    responseFormat,
    seed,
  }: Parameters<LanguageModelV1['doGenerate']>[0], settings?: PortkeyCompletionSettings) {
    ...
    const { prompt: completionPrompt, stopSequences } =
      convertVercelLanguageModelPromptToPortkeyCompletionPrompt({ prompt, inputFormat });
...
export async function transformStream(inputStream: APIPromise<Stream<TextCompletion>>): Promise<ReadableStream<LanguageModelV1StreamPart>> {
